...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/models/M350/continuous_model', glob('models/M350/continuous_model/*')),
        ('share/' + package_name + '/models/M350/discrete_model', glob('models/M350/discrete_model/*')),
    ],
